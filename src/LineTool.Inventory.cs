...
internal static partial class LineTool
{
    ...
    // Hover-wobble pose, live-tuned: group roll (0,0,90), stake world euler (90,10,0), pivot -0.37.
    ...
    // Live-tuned so the INVENTORY browse model reads world-euler ~(90,10,0) — stake lying
    ...
    // Live-tuned + user-approved: StakeVisual world euler (90,10,0) resolves to this LOCAL
    ...
    // The freshly crafted stick sat too low on the mat. Live-tuned to +0.2 along the
    ...
    // (live-tuned to world euler (90,0,85), user-approved): that resolves to this LOCAL
